...
TODO save this out into an intermediate csv? -> the input data, right? Done. I made a separate preprocessing script for reading and fixing ids locally, moving the connect ID data to /VAST/ and retaining the randomized subject ids. 
